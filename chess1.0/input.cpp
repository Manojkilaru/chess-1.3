...
//            continue;
//        }
//        else if (board[present.initial.x][present.initial.y]==NULL) {
//            continue;
//        }
...
bool input(piece *board[12][8],bool usercolour){
    ...
    do{
        ...
        if (board[s[4]-49+2][s[3]-97]!=NULL&&board[s[4]-49+2][s[3]-97]->colour==board[s[1]-49+2][s[0]-97]->colour) {
            cout<<"please";
            continue;
        }
        present.initial.x=s[1]-49+2;
