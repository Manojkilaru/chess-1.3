...
bool pawn::is_check(piece *board[12][8]){
    if (colour==1) {
        if(isalive(mine.x+1,mine.y+1)&&board[mine.x+1][mine.y+1]!=NULL&&board[mine.x+1][mine.y+1]->tostring()=="king"&&board[mine.x+1][mine.y+1]->colour!=colour)
            return true;
        if (isalive(mine.x+1,mine.y-1)&&board[mine.x+1][mine.y-1]!=NULL&&board[mine.x+1][mine.y-1]->tostring()=="king"&&board[mine.x+1][mine.y-1]->colour!=colour) {
            return true;
    }
...
bool rook::is_check(piece *board[12][8]){
    int i;
    for (i=mine.x+1;isalive(i,mine.y)&&board[i][mine.y]==NULL;i++) {
    ...
    for (i=mine.y+1;isalive(mine.x,i)&&board[mine.x][i]==NULL;i++) {
...
bool knight::is_check(piece *board[12][8]){
    if (isalive(mine.x+2,mine.y+1)&&board[mine.x+2][mine.y+1]!=NULL&&board[mine.x+2][mine.y+1]->colour!=colour&&board[mine.x+2][mine.y+1]->tostring()=="king")
    {
        return true;
    }
    else if (isalive(mine.x+1,mine.y+2)&&board[mine.x+1][mine.y+2]!=NULL&&board[mine.x+1][mine.y+2]->colour!=colour&&board[mine.x+1][mine.y+2]->tostring()=="king")
    {
        return true;
    }
    else if (isalive(mine.x-1,mine.y+2)&&board[mine.x-1][mine.y+2]!=NULL&&board[mine.x-1][mine.y+2]->colour!=colour&&board[mine.x-1][mine.y+2]->tostring()=="king")
    ...
    else if (isalive(mine.x-2,mine.y+1)&&(board[mine.x-2][mine.y+1]!=NULL&&board[mine.x-2][mine.y+1]->colour!=colour&&board[mine.x-2][mine.y+1]->tostring()=="king"))
    {
        return true;
    }
    else if (isalive(mine.x-2,mine.y-1)&&(board[mine.x-2][mine.y-1]!=NULL&&board[mine.x-2][mine.y-1]->colour!=colour&&board[mine.x-2][mine.y-1]->tostring()=="king"))
...
bool bishop::is_check(piece *board[12][8]){
    int i;
    for (i=1;isalive(mine.x+i,mine.y+i)&&board[mine.x+i][mine.y+i]==NULL;i++) {
